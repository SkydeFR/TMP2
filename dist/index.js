...
module.exports = function main(options, cb) {
  ...
  let serverClosing = false; // Setup error handling

  function unhandledError(err) {
    // Log the errors
    console.error(err); // Only clean up once

    if (serverClosing) {
      return;
    }

    serverClosing = true; // If server has started, close it down
  ...
  require('./routes')(app, opts); // Common error handlers
